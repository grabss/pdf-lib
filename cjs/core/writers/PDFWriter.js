...
var PDFWriter = /** @class */ (function () {
    ...
    PDFWriter.prototype.computeBufferSize = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var header, size, xref, pdfSecurity, indirectObjects, idx, len, indirectObject, ref, object, xrefOffset, trailerDict, trailer;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        pdfSecurity = this.context.getSecurity();
    ...
    PDFWriter.prototype.encrypt = function (ref, object, pdfSecurity) {
        var encryptFn = pdfSecurity.getEncryptFn(ref.objectNumber, ref.generationNumber);
        var toBeEncrypt = object.getContents();
        if (encryptFn) {
