...
var PDFContext = /** @class */ (function () {
    ...
    PDFContext.prototype.getSecurity = function () {
        return this._security;
    };
    PDFContext.prototype.setSecurity = function (pdfSecurity) {
        utils_1.assertSecurity(pdfSecurity, 'PDFSecurity Instance');
    ...
    PDFContext.prototype.obj = function (literal) {
        if (literal instanceof PDFObject_1.default) {
            ...
            return PDFHexString_1.default.of(utils_1.Uint8ArrToHex(literal));
        }
